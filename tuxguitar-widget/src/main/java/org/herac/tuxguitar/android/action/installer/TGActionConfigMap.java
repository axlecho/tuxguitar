...
public class TGActionConfigMap extends TGActionMap<TGActionConfig> {
    ...
    public void createConfigMap() {
        ...
        this.map(TGMuteTrackAction.NAME,LOCKABLE,UPDATE_ITEMS_CTL);
        ...
        this.map(TGEnableCountDownAction.NAME, LOCKABLE, UPDATE_ITEMS_CTL);
        this.map(TGEnableMetronomeAction.NAME, LOCKABLE, UPDATE_ITEMS_CTL);
        ...
        this.map(TGProcessTitleAction.NAME, LOCKABLE, UPDATE_ITEMS_CTL);
        //switch orientation
        this.map(TGSwitchOrientationAction.NAME, LOCKABLE, UPDATE_ITEMS_CTL);
        this.map(TGFullScreenAction.NAME,LOCKABLE,UPDATE_ITEMS_CTL);
    }
