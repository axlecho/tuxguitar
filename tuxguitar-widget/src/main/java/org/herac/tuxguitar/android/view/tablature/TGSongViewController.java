...
public class TGSongViewController implements TGController {
    ...
    private TGSongViewTitlePainter titlePainter;
    ...
    public TGSongViewController(TGContext context) {
        ...
        this.titlePainter = new TGSongViewTitlePainter(this);
    ...
    public void updateScroll(TGRectangle bounds) {
        ...
        this.getScroll().getY().setMaximum(Math.max((this.getLayout().getHeight() - bounds.getHeight() + this.getTitlePainter().getTitleHeight()), 0));
    }
